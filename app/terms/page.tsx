...
export const metadata: Metadata = {
  title: "Terms",
  description: "LIXIANG Trade website terms of service."
};
    ...
    <section className="bg-white py-16">
      <div className="container-page max-w-3xl">
        ...
        <div className="mt-8 space-y-5 leading-8 text-ink/70">
          ...
          <p>Product directions, service descriptions, availability, commercial terms, and program details may change without notice. This website does not process payments or create purchase contracts online.</p>
          ...
          <p>For questions about these terms, contact info@lixiangtrade.org.</p>
        </div>
      </div>
    </section>
  );
